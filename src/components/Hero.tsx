  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-10 gap-12 items-center">
        {/* Right Side (Above on mobile, Right on Desktop) */}
        <motion.div
        ...
        {/* Left Side (Below on mobile, Left on Desktop) */}
        <motion.div
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl leading-[1.1] tracking-tight text-espresso">
              ...
              <span className="italic">
                <TextReveal text="Search" className="inline-block" delay={0.4} />{" "}
                <span className="text-gold">
                  <TextReveal text="Dominance" className="inline-block" delay={0.5} />
                </span>
              </span>{" "}
              <TextReveal text="&" className="inline-block" delay={0.6} />{" "}
              <span className="text-gold">
                <TextReveal text="Impact." className="inline-block" delay={0.7} />
              </span>
            </h1>
          </motion.div>
